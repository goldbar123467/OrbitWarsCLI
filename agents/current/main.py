...
STRATEGY = {'expansion': 'high', 'aggression': 'medium', 'defense': 'medium', 'comet_usage': 'off', 'endgame_swarm': True}
TARGET = {'distance_weight': 100.0, 'production_weight': 15.0, 'enemy_bonus': 10.0, 'neutral_bonus': 4.0, 'ship_cost_weight': 0.7, 'eta_penalty': 2.0, 'future_production_weight': 0.15}
...
ATTACKS = {'min_attack_ships': 5, 'send_fraction': 0.55, 'cooperative_attacks': True, 'coop_planet_cap': 8, 'avoid_duplicate_targeting': True, 'avoid_oversending': True, 'reserve_ships': 4, 'max_attacks_per_turn': 12}
