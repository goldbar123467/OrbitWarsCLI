...
STRATEGY = {'expansion': 'low', 'aggression': 'low', 'defense': 'high', 'comet_usage': 'off', 'endgame_swarm': True}
TARGET = {'distance_weight': 135.0, 'production_weight': 12.0, 'enemy_bonus': 3.0, 'neutral_bonus': 4.0, 'ship_cost_weight': 0.7, 'eta_penalty': 2.0, 'future_production_weight': 0.15}
...
ATTACKS = {'min_attack_ships': 5, 'send_fraction': 0.35, 'cooperative_attacks': True, 'coop_planet_cap': 8, 'avoid_duplicate_targeting': True, 'avoid_oversending': True, 'reserve_ships': 12, 'max_attacks_per_turn': 6}
DEFENSE = {'detect_incoming_fleets': True, 'reinforce_under_attack': True, 'reserve_home_planet_ships': 18, 'abandon_doomed_planets': False, 'threat_horizon': 70}
