...
STRATEGY = {'expansion': 'medium', 'aggression': 'low', 'defense': 'medium', 'comet_usage': 'off', 'endgame_swarm': False}
TARGET = {'distance_weight': 120.0, 'production_weight': 10.0, 'enemy_bonus': 4.0, 'neutral_bonus': 4.0, 'ship_cost_weight': 0.7, 'eta_penalty': 3.0, 'future_production_weight': 0.15}
PHYSICS = {'sun_avoidance': True, 'sun_radius': 13.0, 'moving_planet_prediction': True, 'comet_prediction': False, 'continuous_collision_check': True, 'max_prediction_ticks': 45}
ATTACKS = {'min_attack_ships': 5, 'send_fraction': 0.45, 'cooperative_attacks': False, 'coop_planet_cap': 8, 'avoid_duplicate_targeting': True, 'avoid_oversending': True, 'reserve_ships': 6, 'max_attacks_per_turn': 12}
